...
class _Otostop2_ extends State<_Otostop2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: appBarClass.getAppBar(1),
                                  ...
                                  child: Column(children: <Widget>[
                                    ...
                                    Row(
                                      children: <Widget>[
                                        ...
                                        CircleAvatar(
                                          child:
                                              Image.asset('images/header.jpeg'),
                                        )
                                      ],
                                    )
                                  ]),
